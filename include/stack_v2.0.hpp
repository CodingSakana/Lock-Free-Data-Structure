...
unsigned const int max_hazard_pointers = 100;
HazardPointer hazard_slot[max_hazard_pointers];
HazardPointer* acquire_hazard_pointer();
void release_hazard_pointer(HazardPointer* hp);
